...
extern "C"{
    void InitPlayer(char* url,char* cookie,float left,float top,float width,float height,bool isPop,bool needUpdate);
...
void InitPlayer(char* url,char* cookie,float left,float top,float width,float height,bool isPop,bool needUpdate){
    ...
    [avp initPlayerWithVideoUrl:videoUrl cookie:cookieStr left:left top:top width:width height:height isPop:isPop needUpdate:needUpdate];
}
