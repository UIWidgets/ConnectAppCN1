    ...
    abstract class ListSyntax : BlockSyntax {
        ...
        public override Node parse(BlockParser parser) {
            ...
            while (!parser.isDone) {
                ...
                if (this.tryMatch(BlockParser._emptyPattern, parser, ref match)) {
                ...
                else if (this.tryMatch(BlockParser._hrPattern, parser, ref match)) {
                    // Horizontal rule takes precedence to a new list item.
                    break;
                }
                else if (this.tryMatch(BlockParser._ulPattern, parser, ref match) ||
                         this.tryMatch(BlockParser._olPattern, parser, ref match)) {
