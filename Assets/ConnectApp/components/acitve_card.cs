                        ...
                        new Container(
                            ...
                            child:new Column(
                                ...
                                children:new List<Widget>
                                {
                                    ...
                                    new Text(model.live?$"20:00 · {model.participantsCount}人已预订":"20:00 · 旧金山Unity大厦",style:CTextStyle.PSmall)
                                }  
                             )
                            ),
                        //pic
...
//                                            width:114,
//                                            height:76,
                                            child:Image.network(model.background,fit:BoxFit.cover)    
                                        )
//                                new Positioned(
//                                    bottom:0,
//                                    right:0,
...
//                                        child:new Text(model.live?"线上":"线下",style:new TextStyle(
//                                            height: 1.67f,
//                                            fontSize: 12,
