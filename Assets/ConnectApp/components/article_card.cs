                                    ...
                                    child:new Row(
                                        ...
                                        children:new List<Widget>
                                        {
                                            new Container(
                                               ...
                                               child:new Text("我们将分享加拿大游戏特效大神Mirza Beig的粒子特效的系列教程,该系列教程将帮助你了解如何使用粒子系统制作精美的特效。",style:CTextStyle.PRegular,maxLines:3,overflow:TextOverflow.ellipsis)
                                            ),
                                            new Padding(
                                    ...
                                    child:new Row(
                                        ...
                                        children:new List<Widget>{
                                            ...
                                            new GestureDetector(
                                                child:new Container(
                                                    height:20,
                                                    child:new Icon(Icons.ellipsis,null,20,Color.fromRGBO(181,181,181,1))),
                                                onTap: () => { }
                                             )
                                        }
                                    )
