...
namespace ConnectApp.utils {
    ...
    public static class EventBus {
        private static readonly Dictionary<string, Dictionary<string, _Delegate>> _globalSubscription
        ...
        public static bool publish(string sName, List<object> args) {
            if (_globalSubscription.ContainsKey(sName)) {
                foreach (var keyValuePair in _globalSubscription[sName].Values) keyValuePair(args);
                return true;
            }
